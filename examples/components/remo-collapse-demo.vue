    ...
    <div v-if="this.locale === 'cn'">
      ...
      <demo-block title="嵌套" desc="可嵌套多层点击控制隐藏：">
            ...
            <re-collapse :show.sync="show2">
              <p>点内容不可关闭 ♪(^∇^*)</p>
              <p>点内容不可关闭 \(^o^)/~</p>
               <re-button @click="handleshow3">点击看详情</re-button>
  ...
  data () {
    return {
      ...
      tableData_en: [
        {
          parameter: 'show.sync',
          description: 'collaspe visible value',
          dataTypes: 'Boolean',
          optional: 'true / false',
          default: 'false'
        },
        {
          parameter: 'bodyClose',
          description: 'Whether the body of collapse can be clicked to close',
          dataTypes: 'Boolean',
          optional: 'true / false',
          default: 'true'
        }
