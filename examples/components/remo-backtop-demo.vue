  ...
  data () {
    return {
      tabledata: [
        ...
        {
          parameter: 'color',
          description: '自定义颜色需和type为customize一并使用',
          dataTypes: 'String',
          option: '',
          default: '#409eff'
        },
...
.testarea{
  ...
  width: 100%;
  height: 700px;
  // border: 1px solid rgba(255, 221, 255, 0.933);
  background: repeating-linear-gradient(45deg, #999, rgba(221, 237, 255, 0.933), #fff 2px);
  text-align: center;
  font-weight: 600;
  font-size: 40px;
  line-height: 700px;
