  ...
  <div>
    <div v-if="this.locale==='cn'">
        ...
        <demo-block title="预览" desc="图片预览/上传">
            ...
            <template slot="code">
              <code class="html">{{fCode(preview.code.html)}}</code>
            </template>
        </demo-block>
        ...
        <demo-block title="压缩" desc="图片0.5X压缩/上传">
            ...
            <template slot="code">
              <code class="html">{{fCode(compress.code.html)}}</code>
            </template>  
        </demo-block>
  ...
  data () {
    return {
      ...
      compress:{
        code:{
          html:`
          <re-upload-img :width="300" :height="300" :outputSize='0.5' addText="compress / upload" :cropper="true" v-model="list4">
          </re-upload-img>
          `
        }
      },
      ...
      tableData_en: [
        ...
        {
          parameter: 'max',
          description: 'Maxiumn number of uploads',
          dataTypes: 'Number',
          optional: '-',
          default: '-'
        },
        {
          parameter: 'width',
          description: 'Showing container width',
          dataTypes: 'Number',
          optional: '-',
          default: '110'
        },
        {
          parameter: 'height',
          description: 'Showing container height',
          dataTypes: 'Number',
          optional: '-',
          default: '110'
        },
        {
          parameter: 'view',
          description: 'Whether uploader can be previewed',
          dataTypes: 'Boolean',
          optional: 'true / false',
          default: 'true'
        },
        {
          parameter: 'cropper',
          description: 'Whether uploader can be cropped',
          dataTypes: 'Boolean',
          optional: 'true / false',
          default: 'false'
        },
        {
          parameter: 'fixed',
          description: 'Enable fixed ratio',
          dataTypes: 'Boolean',
          optional: 'true / false',
          default: 'true'
        },
