    ...
    return {
      ...
      tableData: [
        ...
        },
        {
          ...
          dataTypes: 'String',
          optional: 'all / image / video / (specifiy type)',
          default: 'all'
        }
      ],
      tableData_en: [
        {
          parameter: 'v-model / value',
          description: 'files binding value',
          dataTypes: 'Array',
          optional: '',
          default: ''
        },
        {
          parameter: 'uploadText',
          description: 'upload button content',
          dataTypes: 'String',
          optional: '-',
          default: 'choose file'
        },
        {
          parameter: 'fileSize',
          description: 'Maximum size of uploaded file (byte)',
          dataTypes: 'Number',
          optional: '-',
          default: '10240000'
        },
